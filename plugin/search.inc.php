...
// 更新履歴
// 09-02-01 51,57,105,107～112,91,94
// 09-11-23 テキストエリアサイズを変更
...
<form action="$script?cmd=search" method="post">
 <p>
  <input type="text"  name="word" value="$s_word" size="60" />
  <input type="hidden" name="type" id="_p_search_AND" value="AND" $and_check />

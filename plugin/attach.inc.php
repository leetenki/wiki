...
<form enctype="multipart/form-data" action="$script" method="post">
  ...
  <input type="hidden" name="max_file_size" value="$maxsize" />
	<p>$navi</p>
  <p>$msg_maxsize</p>
  <p><label for="_p_attach_file">{$_attach_messages['msg_file']}:</label><input type="file" name="attach_file" id="_p_attach_file" />
	$pass
  <input type="submit" value="{$_attach_messages['btn_upload']}" /></p>
</form>
EOD;
}

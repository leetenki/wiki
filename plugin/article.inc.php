...
<form action="$script" method="post">
  ...
  <p><label for="_p_article_name_$article_no">$_btn_name</label>
  <input type="text" name="name" id="_p_article_name_$article_no" size="$name_cols" /></p>
  <p><label for="_p_article_subject_$article_no">$_btn_subject</label>
  <input type="text" name="subject" id="_p_article_subject_$article_no" size="$subject_cols" /></p>
  <p><textarea name="msg" rows="$article_rows" cols="$article_cols">\n</textarea></p>
 <p>

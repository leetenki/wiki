...
// 更新履歴
// 09-02-01 PKWKEXP_DISABLE_MULTILINE_PLUGIN_HACKを1に設定
// 09-02-01 $script_directory_indexをonに設定
// 09-02-01 DTDをxhtml1.0 TRANSITIONALに設定
// 09-02-01 アンカーを切り
// 09-02-01 改行を自動入力
...
define('PKWKEXP_DISABLE_MULTILINE_PLUGIN_HACK', 0); // 1 = Disabled // kazuwaya
...
$page_title = 'Private pukiwiki';

// Specify PukiWiki URL (default: auto)
//$script = 'http://example.com/pukiwiki/';

// Shorten $script: Cut its file name (default: not cut)
$script_directory_index = 'index.php';// kazuwaya
...
$pkwk_dtd = PKWK_DTD_XHTML_1_0_TRANSITIONAL;// kazuwaya
...
$autolink = 8; // Bytes, 0 = OFF (try 8) // kazuwaya
...
// Default: always fail
$adminpass = '{x-php-md5}!';
$adminpass = '{x-php-md5}a630ad1e8756060d7c78d477e09f677a';
// Sample:
...
$fixed_heading_anchor = 0;// kazuwaya 1→0

...
$_msg_content_back_to_top = '';// kazuwaya
...
$help_page = 'ヘルプ';		// Help // kazuwaya
$about_page = 'このサイトについて';		// kazuwaya
...
$_LANG['skin']['about']     = 'このサイトについて';// kazuwaya
$_LANG['skin']['add']       = '追加';
...
$_LANG['skin']['new']       = '新規ページ作成'; // kazuwaya
$_LANG['skin']['newsub']    = '下層ページ作成'; // kazuwaya
...
///////////////////////////////////////
// popular.inc.php
$_popular_plugin_frame       = '<h2>人気の%d件</h2><div>%s</div>';// kazuwaya
$_popular_plugin_today_frame = '<h2>今日の%d件</h2><div>%s</div>';// kazuwaya

///////////////////////////////////////
// recent.inc.php
$_recent_plugin_frame = '<h2>最新の%d件</h2><div>%s</div>';// kazuwaya

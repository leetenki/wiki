...
// 更新履歴
// 09-11-20 secedit.inc.phpに対応
// 09-11-23 tableのborderとcellspacingを削除
...
class Table extends Element
{
	...
	function toString()
	{
		...
		$string = $this->wrap($string, 'table', ' class="style_table"');// kazuwaya
...
class YTable extends Element
{
	...
	function toString()
	{
		...
		$rows = $this->wrap($rows, 'table', ' class="style_table"');//kazuwaya
